...
lifedew:{
anim:function(scene,_ref21){var attacker=_ref21[0],defenders=_ref21.slice(1);for(var _i2=0;_i2<
...
shelltrap:{
anim:function(scene,_ref163){var attacker=_ref163[0],defenders=_ref163.slice(1);for(var _i6=0;_i6<
...
boomburst:{
anim:function(scene,_ref198){var attacker=_ref198[0],defenders=_ref198.slice(1);for(var _i12=0;_i12<
...
heatwave:{
anim:function(scene,_ref199){var attacker=_ref199[0],defenders=_ref199.slice(1);for(var _i14=0;_i14<
defenders.length;_i14++){var _defender2=defenders[_i14];
...
icywind:{
anim:function(scene,_ref223){var attacker=_ref223[0],defenders=_ref223.slice(1);for(var _i16=0;_i16<
...
sludgewave:{
anim:function(scene,_ref231){var attacker=_ref231[0],defenders=_ref231.slice(1);for(var _i18=0;_i18<
defenders.length;_i18++){var _defender3=defenders[_i18];
...
rockslide:{
anim:function(scene,_ref242){var attacker=_ref242[0],defenders=_ref242.slice(1);for(var _i20=0;_i20<
...
thousandarrows:{
anim:function(scene,_ref244){var attacker=_ref244[0],defenders=_ref244.slice(1);for(var _i22=0;_i22<
defenders.length;_i22++){var _defender4=defenders[_i22];
...
thousandwaves:{
anim:function(scene,_ref245){var attacker=_ref245[0],defenders=_ref245.slice(1);for(var _i24=0;_i24<
defenders.length;_i24++){var _defender5=defenders[_i24];
...
fierywrath:{
anim:function(scene,_ref254){var attacker=_ref254[0],defenders=_ref254.slice(1);for(var _i26=0;_i26<
...
surf:{
anim:function(scene,_ref290){var attacker=_ref290[0],defenders=_ref290.slice(1);for(var _i28=0;_i28<
defenders.length;_i28++){var _defender6=defenders[_i28];
...
muddywater:{
anim:function(scene,_ref292){var attacker=_ref292[0],defenders=_ref292.slice(1);for(var _i30=0;_i30<
defenders.length;_i30++){var _defender7=defenders[_i30];
...
lavaplume:{
anim:function(scene,_ref294){var attacker=_ref294[0],defenders=_ref294.slice(1);for(var _i32=0;_i32<
...
dragonenergy:{
anim:function(scene,_ref295){var attacker=_ref295[0],defenders=_ref295.slice(1);for(var _i34=0;_i34<
...
defenders.length;_i36++){var _defender8=defenders[_i36];
...
defenders.length;_i38++){var _defender9=defenders[_i38];
...
scene.backgroundEffect("url('https://"+Config.routes.client+"/sprites/gen6bgs/bg-icecave.jpg')",1000,0.6);for(var _i40=0;_i40<
...
darkvoid:{
anim:function(scene,_ref323){var attacker=_ref323[0],defenders=_ref323.slice(1);for(var _i42=0;_i42<
defenders.length;_i42++){var _defender10=defenders[_i42];
_defender10.anim({
y:_defender10.y-80,
opacity:0,
time:300
...
scene.backgroundEffect('#FF99FF',700,0.3);for(var _i44=0;_i44<

defenders.length;_i44++){var _defender11=defenders[_i44];
...
scene.backgroundEffect('#000000',1300,0.3);for(var _i46=0;_i46<

defenders.length;_i46++){var _defender12=defenders[_i46];
...
scene.backgroundEffect('linear-gradient(#46AF71 20%, #1170F0)',1600,0.4,300);for(var _i50=0;_i50<

defenders.length;_i50++){var _defender13=defenders[_i50];
...
scene.showEffect('wisp',{
x:attacker.leftof(-50)+xstep*(_i51+1),
y:attacker.y+275+ystep*(_i51+1),
z:attacker.behind(-150)+zstep*(_i51+1),
scale:1.3,
opacity:1,
time:5*_i51+900
},{
x:defender.leftof(-50)+xstep*(_i51+1),
...
for(var _i52=0;_i52<6;_i52++){
scene.showEffect('wisp',{
x:attacker.leftof(50)+xstep*(_i52+1),
y:attacker.y+275+ystep*(_i52+1),
z:attacker.z+zstep*(_i52+1),
scale:1.3,
opacity:1,
time:5*_i52+1100
},{
x:defender.leftof(50)+xstep*(_i52+1),
opacity:0,
time:100*_i52+1200
},'linear');
}
...
scene.showEffect('poisonwisp',{
x:defender.x+150+xstep*(_i58+1),
y:defender.y+200+ystep*(_i58+1),
z:defender.z+zstep*(_i58+1),
scale:0.6,
opacity:0.7,
time:40*_i58+600
},{
...
scene.showEffect('poisonwisp',{
x:defender.x+200+xstep*(_i59+1),
y:defender.y+200+ystep*(_i59+1),
z:defender.z+zstep*(_i59+1),
scale:0.6,
opacity:0.7,
time:40*_i59+700
},{
...
xstep=(attacker.x-150-attacker.x)/5;
for(var _i65=0;_i65<5;_i65++){
scene.showEffect('energyball',{
x:attacker.x+150+xstep*(_i65+1),
y:attacker.y+200+ystep*(_i65+1),
...
for(var _i66=0;_i66<5;_i66++){
scene.showEffect('mistball',{
x:attacker.x+200+xstep*(_i66+1),
y:attacker.y+200+ystep*(_i66+1),
...
defenders.length;_i68++){var _defender14=defenders[_i68];
