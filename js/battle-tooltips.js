...
outer:for(var _i24=0,_this$battle$sides6=this.battle.sides;_i24<_this$battle$sides6.length;_i24++){var side=_this$battle$sides6[_i24];for(var _i26=0,_side$active4=
side.active;_i26<_side$active4.length;_i26++){var active=_side$active4[_i26];
if(active&&['Air Lock','Cloud Nine'].includes(active.ability)){
weather='';
break outer;
}
...
if(!short){
var hasModifiedStat=false;for(var _i34=0,_Dex$statNamesExceptH6=
Dex.statNamesExceptHP;_i34<_Dex$statNamesExceptH6.length;_i34++){var statName=_Dex$statNamesExceptH6[_i34];
...
Dex.statNamesExceptHP;_i36<_Dex$statNamesExceptH8.length;_i36++){var _statName2=_Dex$statNamesExceptH8[_i36];
